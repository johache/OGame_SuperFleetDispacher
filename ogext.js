...
function InjectSFDView(){
	...
	var HTMLForm = ""
		...
		+ 'Send the <input type="text" id="volleyNumber">th volley of <input type="text" id="fleetsCountVolleyMode"> fleets <br/>'
	...
	HTMLForm += '<input type="checkbox" id="shouldStandadizeFleets"> Standardize fleets: <br/>'
		+ '<table style="margin-left:auto; margin-right:auto;">'
		+ '<td>'
			+ '<table>'
				+ '<tr>'
					+ '<td><input class="fleetValues" type="text" id="SFD_lightFigtersNumber"></td>'
		...
		+ '<td>'
			+ '<table>'
				...
				+ '</tr>'
				+ '<tr>'
					+ '<td><input class="fleetValues" type="text" id="SFD_largeCargosNumber"></td>'
					+ '<td>Large cargos</td>'
				+ '</tr>'
				+ '<tr>'
